'use-strict';
{
    ...
    <li class="pe-2"><a href="index.html" class="fs-4 text-dark text-decoration-none">top</a></li>
      ...
      <li class="pe-3"><a class="sub-text fs-3 text-dark text-decoration-none">volleyball</a>
        <ul class="list-unstyled">
          <li class="my-4"><a class="sub-text fs-6 text-dark text-decoration-none" href="events/vleague-wo23-24.html">V.LEAGUE WOMEN1
            <br>2023~24</a></li>
          </ul>
        </li>
        <li class="pe-3"><a class="sub-text fs-3 text-dark text-decoration-none">figureskate</a>
          <ul class="list-unstyled">
