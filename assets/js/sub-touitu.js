'use-strict';
{
    ...
    <ul id="nav" class="sports-list d-flex list-unstyled pt-2">
      ...
      <ul class="list-unstyled">
        <li class="my-4"><a class="fs-5 text-dark text-decoration-none" href="baseball-tiger24-1-op.html">阪神タイガース
          <br>1軍オープン戦2024</a></li>
        <li class="my-4"><a class="fs-5 text-dark text-decoration-none" href="th-other-baseball24-1-op.html">阪神以外
          <br>1軍オープン戦2024</a></li>
        </ul>
      </li>
      <li class="pe-3"><a href="#" class="sub-text fs-3 text-dark text-decoration-none">volleyball</a>
        <ul class="list-unstyled">
          <li class="my-4"><a class="sub-text fs-5 text-dark text-decoration-none" href="jtmave23.html">JTマーヴェラス
            <br>2023~2024</a></li>
          </ul>
        </li>
        <li class="pe-3"><a href="#" class="sub-text fs-3 text-dark text-decoration-none">fhigireskate</a>
          <ul class="list-unstyled">
            <li class="my-4"><a class="sub-text fs-5 text-dark text-decoration-none" href="zenja-figskate23.html">2023全日本
              <br>フィギアスケート選手権</a></li>
            </ul>
          </li>
