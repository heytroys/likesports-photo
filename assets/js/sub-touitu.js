  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item fs-4 text-decoration-none" href="baseball-tiger24-1-op.html">阪神タイガース1軍'24<br>オープン戦</a></li>
        <li><a class="dropdown-item fs-4 text-decoration-none" href="th-other-baseball24-1-op.html">阪神以外1軍'24<br>オープン戦</a></li>
      </ul>
    </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle fs-3 text-dark text-decoration-none ps-1" to="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item fs-4 text-decoration-none" href="jtmave23.html">JTマーヴェラス・'23~'24</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle fs-3 text-dark text-decoration-none ps-1" to="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item fs-4 text-decoration-none" href="zenja-figskate92.html">第92回<br>全日本フィギアスケート</a></li>
          </ul>
        </li>
        <li class="nav-item">
          <a class="nav-link fs-3 text-dark text-decoration-none ps-1" href="prof.html">profile</a>
        </li>
      </ul>
    </div>
  </div>
